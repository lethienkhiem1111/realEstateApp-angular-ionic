...
import { PlaceLocation, Coordinates } from 'src/app/shared/location.module';
import { of } from 'rxjs';
  ...
  private locateUser() {
    ...
    Plugins.Geolocation.getCurrentPosition()
      .then(geoPosition => {
        ...
        console.log('Day la coordinates: '+ coordinates )
        this.createPlace(coordinates.lat, coordinates.lng);
        this.isLoading = false;
      })
      .catch(err => {
        console.log('Co plugin')
        this.showErrorAlert();
      })
  }
